// resources/flows/achizitie-teren/Tabs/index.js
// ---------------------------------------------------------------------------
// Plain JSON‑ish data (no real React components) but **keeps Tailwind classes**
// via `className` so the string can be copied into a future JSX component.
// Each entry: { title, html, assets[] }
